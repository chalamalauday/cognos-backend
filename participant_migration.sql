-- COGNOS 2K26 participant records upgrade
-- Use this file when the accommodation and Vishleshana flag migrations were already imported.
-- Run once in phpMyAdmin after selecting the cognos_2k26 database.
